...
public class System_out_printf {
	public static void main(String[] args) {
		...
		// Question 1
//		int soNguyen = 5;
//		System.out.printf("Số nguyên: %d ", soNguyen);
//	}

		// Question 2
//		long soNguyen = 26445656156161l;
//		System.out.printf(Locale.US, "%,d%n", soNguyen);

		// Question 3
//		float f = 166.1565654f;
//		System.out.printf("%.4f", f);

		// Question 4
//		String s = "Nguyễn Sỹ Phước";
